<section class="width bg-black text-gray-200">
	<div class="mx-6 mb-32 mt-12 md:mx-12 lg:mx-24">
		<div class="terms">
			<h2>WEBSPARK+ PRIVACY POLICY & TERMS OF USE</h2>
			<p>
				This Privacy Policy describes how your personal information is collected, used, and shared
				when you visit or make a purchase from www.websparkplus.com (the “Site”).
			</p>
			...
			<p>
				...
				visit http://www.allaboutcookies.org. - “Log files” track actions occurring on the Site, and
			...
			<p>
				We use the Order Information that we collect generally to fulfill any website orders placed
				through the site. Additionally, we use this Order Information to: Communicate with you;
				Screen our orders for potential risk or fraud; and When in line with the preferences you
				have shared with us, provide you with information or advertising relating to our products or
				services. We use the Device Information that we collect to help us screen for potential risk
			...
			<p>
				...
				customers use our website. You can read more about how Google uses your Personal Information
				...
				or to otherwise protect our rights. <br />
				...
				how targeted advertising works, you can visit the Network Advertising Initiative’s (“NAI”) educational
			...
			<p>
				...
				like to make a complaint, please contact us by e-mail at info@websparkplus.com or through
